...
typedef enum : NSUInteger {
    PasscodeViewControllerNewPasscodeType,
    PasscodeViewControllerChangePasscodeType,
    PasscodeViewControllerCheckPasscodeType
} PasscodeViewControllerType;

@protocol PasscodeViewControllerDelegate;

@interface PasscodeViewController : UIViewController <BKPasscodeInputViewDelegate>

@property (nonatomic, unsafe_unretained) id<PasscodeViewControllerDelegate> delegate;

@property (nonatomic) PasscodeViewControllerType              type;
 ...
 */
- (void)passcodeViewController:(PasscodeViewController *)aViewController didFinishWithPasscode:(NSString *)aPasscode;
 ...
 */
- (void)passcodeViewController:(PasscodeViewController *)aViewController authenticatePasscode:(NSString *)aPasscode resultHandler:(void(^)(BOOL succeed))aResultHandler;
 ...
 */
- (void)passcodeViewControllerDidFailAttempt:(PasscodeViewController *)aViewController;

/**
 * Ask the delegate that how many times incorrect passcode entered to display failed attempt count.
 */
- (NSUInteger)passcodeViewControllerNumberOfFailedAttempts:(PasscodeViewController *)aViewController;
 ...
 */
- (NSDate *)passcodeViewControllerLockUntilDate:(PasscodeViewController *)aViewController;
