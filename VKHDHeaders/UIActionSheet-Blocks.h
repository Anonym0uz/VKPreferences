...
+ (id)showFromBarButtonItem:(id)arg1 animated:(_Bool)arg2 withTitle:(id)arg3 cancelButtonTitle:(id)arg4 destructiveButtonTitle:(id)arg5 destructiveButtonIndex:(long long)arg6 otherButtonTitles:(id)arg7 tapBlock:(CDUnknownBlockType)arg8;
...
@property(nonatomic) _Bool isBeignDismissed;
@property(nonatomic) __weak UIViewController *presentedViewController;
