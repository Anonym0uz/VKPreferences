...
// delegate
@property (nonatomic, unsafe_unretained) id<BKPasscodeFieldDelegate> delegate;
@property (nonatomic, unsafe_unretained) id<BKPasscodeFieldImageSource> imageSource;
